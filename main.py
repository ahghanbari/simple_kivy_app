...
class MainApp(App):
    ...
    def build(self):
        ...
        self.potrick_layout = BoxLayout(orientation="horizontal")
        Righ_layout.add_widget(self.potrick_layout)
    ...
    def solve(self, instance):
        ...
        if not WrongInput:
            ...
            # now, we have 2 list, potrick and bob, the array of their Cards, and
            # their score in bob_score and pot_score
        ...
        self.potrick_layout.clear_widgets()
        ...
        img_potrick = Image(source='p.png',
                    size_hint=(.5, .5),
                    pos_hint={'center_x':1, 'center_y':.5})
        self.potrick_layout.add_widget(img_potrick)
        self.potrick_layout.add_widget(Label(text=temp_pot, font_size ='30sp', markup=True))
